		...
		if (/^a(s|ss)alamu('|)alaikum(| )(wr|)( |)(wb|)$/.test(budy?.toLowerCase())) {
			...
			case 'setpacknamebot': case 'setbotpackname': {
				...
				if (text || m.quoted) {
					...
					m.reply(global.mess.done)
				} else m.reply(`Example: ${prefix + command} By Epul bot`)
			}
			break
...
│${setv} ${prefix}upstory
│${setv} ${prefix}setnamebot
│${setv} ${prefix}setpacknamebot
│${setv} ${prefix}public
│${setv} ${prefix}self
╰──────❍`)
			}
